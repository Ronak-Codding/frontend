...
const ACCORDION_ITEMS = [
  {
    ...
    body: "These cookies are strictly necessary for the SkyWave website to function. They enable core features such as passenger authentication, booking session management, and fraud prevention during payment. You cannot opt out of these cookies as the site would not work without them.",
  },
  {
    icon: "⚙️",
  ...
  return (
    <section className="hero">
      ...
      <h1 className="hero-title">
        ...
        <span className="line2">SkyWave Airlines</span>
      </h1>
    ...
    >
      <div className="modal">
        <div className="modal-header">
          <h2 className="modal-title">Manage Cookie Preferences</h2>
    ...
    >
      <div className="consent-inner">
        <div className="consent-text">
          <p>
            <strong>SkyWave uses cookies </strong> — We use essential,
  ...
  return (
    <>
     ...
     <Breadcrumb title="Cookie Policy"/>
        ...
        <main className="content-area" ref={contentRef}>
          ...
          <div className="intro-card">
            ...
            <p>
              ...
              <strong>SkyWave Airlines Ltd</strong> ("we", "us", "our") uses
              cookies and similar tracking technologies when you use our website
              at <strong>skywave.com</strong> — including flight search,
              booking, check-in, and account management. Please read this policy
              alongside our <a href="#">Privacy Policy</a>.
            </p>
          </div>
          ...
          <section id="what-are-cookies" className="policy-section">
            ...
            <div className="section-body">
              ...
              <p>
                ...
                "cookies" in this policy — to collect information about how you
                interact with our booking platform.
              </p>
              <p>
                Cookies can be <em>first-party</em> (set by SkyWave directly) or{" "}
                <em>third-party</em> (set by our trusted partners such as
          ...
          <section id="types-we-use" className="policy-section">
            ...
            <div className="section-body">
              <p>
                ...
                purpose in delivering your SkyWave experience:
              </p>
            </div>
              ...
              <table className="cookie-table">
                ...
                <tbody>
                  {COOKIE_ROWS.map((row) => (
                    <tr key={row.name}>
                      <td>
                        <code style={{ color: "#7ec8f0", fontSize: "0.82rem" }}>
                          {row.name}
                        </code>
                      </td>
                      <td>
                      ...
                      <td>{row.purpose}</td>
                      <td style={{ whiteSpace: "nowrap", color: "#9ba5b7" }}>
                        {row.duration}
                      </td>
                    </tr>
                  ))}
          ...
          <section id="third-party" className="policy-section">
            ...
            <div className="section-body">
              <p>
                ...
                trusted third-party providers. These providers may set their own
                cookies on your device, subject to their own privacy policies.
              ...
              <p>
                <strong>Meta (Facebook) Pixel</strong> — Conversion tracking and
                custom audience targeting. Learn more:{" "}
                <a
          ...
          <section id="your-choices" className="policy-section">
            ...
            <div className="section-body">
              <p>
                ...
                your preferences at any time using the button below, which opens
              ...
              <p style={{ marginTop: "1rem" }}>
                ...
                refuse cookies, delete existing cookies, and set preferences for
                specific sites. Note that disabling essential cookies will
          ...
          <section id="updates" className="policy-section">
            ...
            <div className="section-body">
              ...
              <p>
                ...
                continued use of the SkyWave website after any update
          ...
          <section id="contact" className="policy-section">
            ...
            <div className="section-body">
              ...
              <p>
                <strong>SkyWave Airlines — Data Protection Office</strong>
                <br />
                📧 <a href="mailto:privacy@skywave.com">privacy@skywave.com</a>
                <br />
                🏢 SkyWave House, Terminal 2, London Heathrow, TW6 1AP, United
                Kingdom
                <br />
                📞 +44 (0) 20 7946 0321
              </p>
      ...
      <ConsentBanner onManage={() => setModalOpen(true)} onAccept={() => {}} />
